...
// date format is strict. 2010-10-20 4:30, "YYYY-MM-DD HH:mm"
// do not remove any commas, paranthesis or apostrophes inside the below object.
...
const grams = {
    bananamantis: {
        ...
        messageBoxURL: '',
        messagePlaceholder: '',
        messageReveal: 'HI I made you a super cute gram.',
